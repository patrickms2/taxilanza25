...
class CooperativadetaxisRepository extends BaseRepository implements CooperativadetaxisRepositoryInterface
{
    public function __construct(Cooperativadetaxis $model)
    {
    ...
    public function create(array $attributes, $currentUser)
    {
        try {
            ...
            $cooperativadetaxis = Cooperativadetaxis::create([
...
,
    ...
    public function update($id, array $attributes, $currentUser)
    {
        try {
            $attributes = $attributes['data'];
            DB::beginTransaction();
            $cooperativadetaxis = Cooperativadetaxis::find($id);
            $cooperativadetaxis->update([
                    'name' => $attributes['name'] ?? null
,
