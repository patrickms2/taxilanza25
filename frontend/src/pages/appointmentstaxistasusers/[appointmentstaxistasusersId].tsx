...
const EditAppointmentstaxistasusers = () => {
  ...
  const { appointmentstaxistasusersId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: appointmentstaxistasusersId }));
  }, [appointmentstaxistasusersId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: appointmentstaxistasusersId, data }));
    await router.push(
...
EditAppointmentstaxistasusers.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditAppointmentstaxistasusers;
