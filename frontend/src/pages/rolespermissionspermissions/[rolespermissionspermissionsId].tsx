...
const EditRolespermissionspermissions = () => {
  ...
  const { rolespermissionspermissionsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: rolespermissionspermissionsId }));
  }, [rolespermissionspermissionsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: rolespermissionspermissionsId, data }));
    await router.push(
...
EditRolespermissionspermissions.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
...
export default EditRolespermissionspermissions;
