...
const DocumentsTablesPage = () => {
  ...
  const [filters] = useState([
    ...
    { label: 'month', title: 'month', number: 'true' },

    { label: 'creation_date', title: 'creation_date', date: 'true' },

    { label: 'creatorid', title: 'creatorid' },
...

    {
      ...
      title: 'document_type',
      type: 'enum',
      options: ['public.enum_documents_document_type', 'departmentId uuid'],
    },
  ]);
