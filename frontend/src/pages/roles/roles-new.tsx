        ...
        <CardBox>
          ...
          >
            <Form>
              ...
              <FormField label='role_customization'>
                <Field
                  name='role_customization'
                  placeholder='role_customization'
                />
              </FormField>

              <FormField label='globalaccess' labelFor='globalaccess'>
                <Field
                  name='globalaccess'
                  id='globalaccess'
...
RolesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_ROLES'}>
      {page}
    </LayoutAuthenticated>
  );
};
