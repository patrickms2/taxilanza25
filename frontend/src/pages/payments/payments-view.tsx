  ...
  return (
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>serviceid</p>

            <p>{payments?.serviceid?.id ?? 'No data'}</p>
          </div>
            ...
            {payments.payment_status ? (
              <DatePicker
                ...
                selected={
                  payments.payment_status
                    ? new Date(
                        dayjs(payments.payment_status).format(
                          'YYYY-MM-DD hh:mm',
                        ),
                      )
                    : null
              ...
              <p>No payment_status</p>
            )}
          </FormField>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>payment_method</p>
            <p>{payments?.payment_method ?? 'No data'}</p>
          </div>
