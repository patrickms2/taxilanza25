...
const EditUserscustom_permissionspermissionsPage = () => {
...
EditUserscustom_permissionspermissionsPage.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
    <LayoutAuthenticated
...
export default EditUserscustom_permissionspermissionsPage;
