...
const EditAppointmentsusersusers = () => {
  ...
  const { appointmentsusersusersId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: appointmentsusersusersId }));
  }, [appointmentsusersusersId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: appointmentsusersusersId, data }));
...
EditAppointmentsusersusers.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditAppointmentsusersusers;
