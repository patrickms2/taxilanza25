...
import { create } from '../../stores/taxisdriversusers/taxisdriversusersSlice';
...
TaxisdriversusersNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_TAXISDRIVERSUSERS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default TaxisdriversusersNew;
